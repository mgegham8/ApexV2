...
contract ApexV2PairFeeTest is Test {
    ...
    function testFeeOffDoesNotMintProtocolLiquidity()
    public
    {

        uint supplyBefore = pair.totalSupply();
        ...
        uint supplyAfter = pair.totalSupply();
    ...
    function testFeeOnMintsProtocolLiquidity()
    public
    {
    ...
    function testKLastUpdatesWhenFeeOn()
    public
    {
    ...
    function testFeeCannotBeManipulatedByDonation()
public
{
    factory.setFeeTo(
        feeReceiver
...
function testFeeOffClearsKLast()
public
{
    // Enable protocol fee
