...
contract ApexV2RouterRemoveLiquidityAdversarialTest is Test {
    ...
    uint256 internal constant TOKEN_BALANCE =
        1_000_000 ether;

    uint256 internal constant ETH_BALANCE =
        10_000 ether;
        ...
        public
    {
        ...
        uint256 lpBefore =
            ApexV2Pair(pair).balanceOf(alice);
    ...
    function test_removeLiquidity_reverseTokenOrder_success()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_revertsWhenAMinTooHigh()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_revertsWhenBMinTooHigh()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_revertsZeroLiquidity()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidity_revertsZeroRecipient()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_revertsExpiredDeadline()
        public
    {
        vm.warp(1000);
    ...
    function test_removeLiquidity_revertsIdenticalTokens()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidity_revertsZeroToken()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidity_revertsMissingPair()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidity_revertsWithoutLPApproval()
        public
    {
        (
            ,
    ...
    function test_removeLiquidityETH_success()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidityETH_revertsTokenMinTooHigh()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidityETH_revertsETHMinTooHigh()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidityETH_revertsZeroLiquidity()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidityETH_revertsZeroRecipient()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidityETH_revertsZeroToken()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidityETH_revertsWETHAsToken()
        public
    {
        vm.prank(alice);
    ...
    function test_removeLiquidityETH_revertsExpiredDeadline()
        public
    {
        vm.warp(1000);
    ...
    function test_removeLiquidityETH_revertsMissingPair()
        public
    {
        vm.prank(alice);
    ...
    function testFuzz_removeLiquidity_partialSuccess(
        uint96 rawPercent
    )
        public
    {
    ...
    function testFuzz_removeLiquidityETH_partialSuccess(
        uint96 rawPercent
    )
        public
    {
