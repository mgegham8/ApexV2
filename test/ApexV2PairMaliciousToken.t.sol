...
contract ApexV2PairMaliciousTokenTest is Test {
    ...
    function feeTokenReserve()
    internal
    view
    returns(uint112 reserve)
    {
        (
            uint112 reserve0,
            uint112 reserve1,
    ...
    function testFeeTokenCannotCreateFakeReserve()
    public
    {
        uint balanceBefore =
            feeToken.balanceOf(
    ...
    function testFeeTokenSwapKeepsInvariant()
    public
    {
        (
            uint112 reserve0,
    ...
    function testDonationDoesNotChangeReserve()
    public
    {
        uint112 before =
            feeTokenReserve();
    ...
    function testSyncWithFeeTokenUsesRealBalance()
    public
    {
        feeToken.mint(
            address(this),
