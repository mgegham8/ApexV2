...
contract ApexV2PairFirstLiquidityAttackTest is Test {
    ...
    */
    function testFirstLiquidityCannotCreateFreeLP() public {
        ...
        uint256 lp = pair.balanceOf(attacker);

        // attacker cannot receive full supply
        assertLt(lp, 1000 ether);
    }
    ...
    */
    function testDonationAfterFirstLiquidityCannotDrain() public {
    ...
    */
    function testTinyInitialLiquidityFails() public {
        token0.mint(attacker, 1);

        token1.mint(attacker, 1);
