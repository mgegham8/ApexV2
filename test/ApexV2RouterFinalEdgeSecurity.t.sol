...
contract ApexV2RouterFinalEdgeSecurityTest is Test {
    ...
    function test_removeLiquidityETH_contractRecipient_success()
        public
    {
        (
            address pair,
        ...
        AcceptETHRecipient recipient =
            new AcceptETHRecipient();
    ...
    function test_removeLiquidityETH_revertsWhenRecipientRejectsETH()
        public
    {
        (
            address pair,
        ...
        RejectETHRecipient recipient =
            new RejectETHRecipient();
        ...
        uint256 aliceLPBefore =
            ApexV2Pair(pair).balanceOf(
                alice
            );

        uint256 pairLPBefore =
            ApexV2Pair(pair).balanceOf(
                pair
            );

        uint256 aliceTokenBefore =
            token.balanceOf(
                alice
            );

        uint256 pairTokenBefore =
            token.balanceOf(
                pair
            );

        uint256 pairWETHBefore =
            weth.balanceOf(
                pair
            );
    ...
    function test_removeLiquidity_exactLPAllowance_success()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_revertsWhenLPAllowanceOneWeiTooLow()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_fullLPBalance_success()
        public
    {
        (
            address pair,
    ...
    function test_removeLiquidity_revertsWhenLiquidityExceedsLPBalance()
        public
    {
        (
            address pair,
    ...
    function test_swapExactTokensForETH_contractRecipient_success()
        public
    {
        _seedSwapPool();
    ...
    function test_swapExactTokensForETH_revertsWhenRecipientRejectsETH()
        public
    {
        address pair =
            _seedSwapPool();
    ...
    function test_removeLiquidityETH_routerRetainsNoTokenOrETHDust()
        public
    {
        (
            address pair,
    ...
    function test_swapExactTokensForETH_doesNotUsePreexistingRouterWETH()
        public
    {
        _seedSwapPool();
    ...
    function testFuzz_removeLiquidityETH_exactAllowance(
        uint96 rawPercent
    )
        public
    {
