...
contract UQ112x112FinalSecurityTest is Test {
    ...
    function testFuzz_encode_matchesShift(
        uint112 value
    )
        public
        view
    ...
    function test_uqdiv_divisorOne()
        public
        view
    {
        uint224 x =
    ...
    function testFuzz_uqdiv_neverExceedsNumerator(
        uint224 x,
        uint112 y
    )
        public
    ...
    function test_encodeThenDivide_oneToOne()
        public
        view
    {
        uint224 encoded =
    ...
    function test_encodeThenDivide_twoToOne()
        public
        view
    {
        uint224 encoded =
    ...
    function testFuzz_encodeThenDivide_matchesFormula(
        uint112 numerator,
        uint112 denominator
    )
        public
    ...
    function testFuzz_encodeThenDivide_integerRatio(
        uint112 base,
        uint112 multiplier
    )
        public
