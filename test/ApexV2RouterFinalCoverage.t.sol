...
contract ApexV2RouterFinalCoverageTest is Test {
    ...
    uint256 internal constant DEADLINE_OFFSET =
        1 days;
    ...
    function test_addLiquidity_existingPool_AOptimal_exactCoverage()
        public
    {
        _createTokenTokenPool(
            1_000 ether,
            2_000 ether
        );
    ...
    function test_addLiquidity_existingPool_BOptimal_exactCoverage()
        public
    {
        _createTokenTokenPool(
            1_000 ether,
    ...
    function test_addLiquidityETH_initialPool_exactCoverage()
        public
    {
        uint256 tokenAmount =
            1_000 ether;
    ...
    function test_addLiquidityETH_existingPool_ETHOptimal_exactCoverage()
        public
    {
        _createTokenETHPool(
            1_000 ether,
    ...
    function test_addLiquidityETH_existingPool_TokenOptimal_exactCoverage()
        public
    {
        _createTokenETHPool(
            1_000 ether,
    ...
    function test_removeLiquidityETH_fullSuccessPath_exactCoverage()
        public
    {
        _createTokenETHPool(
            1_000 ether,
    ...
    function test_removeLiquidityETH_revertsZeroToken_exactCoverage()
        public
    {
        vm.expectRevert(
            bytes(
    ...
    function test_removeLiquidityETH_revertsWETHAsToken_exactCoverage()
        public
    {
        vm.expectRevert(
            bytes(
    ...
    function test_removeLiquidityETH_revertsZeroRecipient_exactCoverage()
        public
    {
        vm.expectRevert(
            bytes(
    ...
    function test_removeLiquidityETH_revertsWhenRecipientRejectsETH_exactCoverage()
        public
    {
        _createTokenETHPool(
            1_000 ether,
        ...
        RejectETHCoverage rejector =
            new RejectETHCoverage();
    ...
    function test_removeLiquidityETH_exactMinimumsAccepted()
        public
    {
        _createTokenETHPool(
            1_000 ether,
    ...
    function _createTokenTokenPool(
        uint256 amountA,
        uint256 amountB
    )
        internal
